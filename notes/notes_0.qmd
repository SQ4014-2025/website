...
-   You can learn more in the Python documentation on [data types](https://docs.python.org/3/library/datatypes.html).
...
-   We can use a comma `,` to pass in multiple arguments by editing our code as follows:
    ...
    The output in the terminal, if we typed “Ed” we would be `hello, Ed`. Success.
