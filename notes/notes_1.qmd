...
-   [Overview](#overview)
-   [Why this matters for "Real World AI"](#why-this-matters-for-real-world-ai)
-   [Generative AI for coders](#generative-ai-for-coders)
-   [Developer tools landscape](#developer-tools-landscape)
-   [How does generative AI work?](#how-does-generative-ai-work)
-   [What an LLM is (and isn't)](#what-an-llm-is-and-isnt)
-   [The potential of LLMs](#the-potential-of-llms)
-   [Generative AI vs code completion](#generative-ai-vs-code-completion)
-   [Other types of generative AI (quick map)](#other-types-of-generative-ai-quick-map)
-   [Project workflow with AI assistance](#project-workflow-with-ai-assistance)
-   [Choosing the right generative AI tools](#choosing-the-right-generative-ai-tools)
-   [Common failure modes (what students must learn)](#common-failure-modes-what-students-must-learn)
-   [Go forth and code!](#go-forth-and-code)
-   [A simple "AI as refactor assistant" workflow](#a-simple-ai-as-refactor-assistant-workflow)
-   [Turning a prompt into a structured specification](#turning-a-prompt-into-a-structured-specification)
-   [A minimal test-first habit](#a-minimal-test-first-habit)
