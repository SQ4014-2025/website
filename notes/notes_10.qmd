...
-   [What is **Cursor**, and why is it different?](#what-is-cursor-and-why-is-it-different)
-   [Project-wide context and customization](#project-wide-context-and-customization)
-   [First concept: build something small, then improve it](#first-concept-build-something-small-then-improve-it)
-   [The initial prompt to build our game](#the-initial-prompt-to-build-our-game)
-   [Cursor basics (chat vs edit vs autocomplete)](#cursor-basics-chat-vs-edit-vs-autocomplete)
-   [Giving feedback (how to steer the model)](#giving-feedback-how-to-steer-the-model)
-   [Adding context (what to paste into chat)](#adding-context-what-to-paste-into-chat)
-   [Selecting a mode (decision table)](#selecting-a-mode-decision-table)
-   [Model selection (speed vs quality)](#model-selection-speed-vs-quality)
-   [MAX mode (when you need the heavy hammer)](#max-mode-when-you-need-the-heavy-hammer)
-   [Results from the first prompt: expect rough edges](#results-from-the-first-prompt-expect-rough-edges)
-   [Running our game for the first time (environment + dependencies)](#running-our-game-for-the-first-time-environment--dependencies)
-   [Making changes to our game: small diffs win](#making-changes-to-our-game-small-diffs-win)
-   [The second prompt (iteration with structure)](#the-second-prompt-iteration-with-structure)
-   [Debugging in a vibe-coding workflow](#debugging-in-a-vibe-coding-workflow)
-   [Figure: example diff](#figure-example-diff)
-   [Rapid-fire practical reminders (for students)](#rapid-fire-practical-reminders-for-students)
-   [Extra extracted figures (from this week)](#extra-extracted-figures-from-this-week)

> "Vibe coding" is a workflow, not a magic trick.

This week we'll explore vibe coding by building a small game (a simple working program you can run).
...
-  “vibe coding” is basically: *you steer by intent and feedback*, not by writing every line from scratch.
...
When you rely on AI, you sometimes stop debugging. That’s dangerous.
