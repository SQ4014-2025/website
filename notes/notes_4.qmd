...
![](images/week_04/fig_01.png)

### Micro-quotes from this week

-   "56 Building applications with AI assistance up project structure and create your first working application"
-   "Week 05 dives into advanced development techniques using tools such as Tabnine and BlackboxAI"
-   "Finally Week 06 focuses on building strong user interfaces and managing sessions with AI-generated code"
-   "I ve done this too"
-   "Taking time to plan an app s architecture leads to happy users and lower maintenance costs"
...
-   Only then decide folder structure and module boundaries. ![](images/week_04/fig_02.png)
...
-   Keep `templates/` for HTML templates and `static/` for CSS/JS/images, matching Flask conventions. ![](images/week_04/fig_03.jpeg)
...
-   When you later add forms, you’ll pass user-submitted values into templates to show results. ![](images/week_04/fig_04.png)
...
## A worked walkthrough: turning the week into a plan {#a-worked-walkthrough-turning-the-week-into-a-plan}
...
### Figure: Chapter 4 structure and setup visuals

![](images/week_04/fig_01.png)

![](images/week_04/fig_02.png)

-   Use these figures as reminders of the “shape” of a small web app.
...
## More micro-quotes from the chapter {#more-micro-quotes-from-the-chapter}

-   Here are a few short phrases from Chapter 4 that capture the intent:

    -   "we’re diving headfirst into the wild world"
    -   "building a useful application"
    -   "integrating these tools into your workflow"

-   Use these as “north stars”: the goal is a *working workflow*, not perfect code.

## Extended checklist for students {#extended-checklist-for-students}
