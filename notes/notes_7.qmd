...
> **Micro-quotes:** "Even seasoned developers can find UI design tough, and generative AI tools help tremendously." "AI tools provide a big boost for developers who aren't great at UI." "First, we need to build a great prompt for this." "7.1 Getting our strategy from our AI tools Before we approach these tools, we should think carefully about our prompt." "If we say "generate a frontend for my application" without enough information, the guidance will be too vague." "There is a time and a place for brief prompts."


-   [What this week is doing (big picture)](#what-this-week-is-doing-big-picture)
-   [Key terms (bolded the first time)](#key-terms-bolded-the-first-time)
-   [Figures extracted from the PDF](#figures-extracted-from-the-pdf)
-   [Getting our strategy from our AI tools](#getting-our-strategy-from-our-ai-tools)
-   [Worked example: prompting for a UI plan (Quarto runnable code)](#worked-example-prompting-for-a-ui-plan-quarto-runnable-code)
-   [From flows to pages: what screens does the user need?](#from-flows-to-pages-what-screens-does-the-user-need)
-   [Translating requirements into template structure](#translating-requirements-into-template-structure)
-   [Wireframes: how to ask the AI for layout help](#wireframes-how-to-ask-the-ai-for-layout-help)
-   [Responsive design basics (what this week wants you to learn)](#responsive-design-basics-what-this-week-wants-you-to-learn)
-   [Jinja2 integration: UI that actually connects to backend data](#jinja2-integration-ui-that-actually-connects-to-backend-data)
-   [Building components: avoiding copy/paste templates](#building-components-avoiding-copy-paste-templates)
-   [Testing UI logic (lightweight sanity checks)](#testing-ui-logic-lightweight-sanity-checks)
-   [Code example: simple Jinja2 loop for quiz list](#code-example-simple-jinja2-loop-for-quiz-list)
-   [Code example: minimal responsive CSS skeleton](#code-example-minimal-responsive-css-skeleton)
-   [Summing Up](#summing-up)
-   [Quick checklist (week skills)](#quick-checklist-week-skills)
