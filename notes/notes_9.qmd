...
-   [Week map (what we're actually learning)](#week-map-what-were-actually-learning)
-   [Micro-quotes from this week (short + placed where relevant)](#micro-quotes-from-this-week-short--placed-where-relevant)
-   [Key terms (bold on first use)](#key-terms-bold-on-first-use)
-   [Figures used in these notes (≈10 max, placed where they matter)](#figures-used-in-these-notes-10-max-placed-where-they-matter)
...
-   [Quick self-check (5 minutes)](#quick-self-check-5-minutes)
-   [Verification report (Week 9)](#verification-report-week-9)
