...
-   [1. Why prompting is a design skill](#1-why-prompting-is-a-design-skill)
-   [2. Prompt anatomy](#2-prompt-anatomy)
-   [3. From vague to specific](#3-from-vague-to-specific)
-   [4. Constraints, rubrics, and acceptance tests](#4-constraints-rubrics-and-acceptance-tests)
-   [5. Few-shot examples](#5-few-shot-examples)
-   [6. Output formats that don’t break](#6-output-formats-that-dont-break)
-   [7. Iteration loop](#7-iteration-loop)
-   [8. Failure modes + debugging prompts](#8-failure-modes--debugging-prompts)
-   [9. Prompt patterns you can reuse](#9-prompt-patterns-you-can-reuse)
-   [10. Summary](#10-summary)

## Figures used in this week

![](images/week_03/fig_01.png){fig-alt="Figure from Week 03" width="85%"} ![](images/week_03/fig_02.png){fig-alt="Figure from Week 03" width="85%"}
...
### Chapter keywords (bold first use)
...
## 6. Output formats that don’t break
...
## Appendix A — Worked walkthrough: building a prompt step by step
