...
![camel](images/1024px-CamelCase_new.svg.png)

Source: [en.wikipedia.org/wiki/Camel\_case](https://en.wikipedia.org/wiki/Camel_case)
...
Open your terminal window. You should find that your terminal window’s prompt resembles the below:
